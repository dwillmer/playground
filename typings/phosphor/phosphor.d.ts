...
declare module phosphor.widgets {
    ...
    class ListView extends Widget {
        ...
        scrollHeight: number;
        /**
         * Set the scroll position of the vertical scroll bar.
         */
        protected setVerticalScrollPosition(value: number): void;
        /**
         ...
         */
        private _hsb_sliderMoved(sender, value);
        /**
         * Handle the `sliderMoved` signal from the vertical scroll bar.
         */
        private _vsb_sliderMoved(sender, value);
        private _canvas;
        private _corner;
